...
./translator ProgramFlow/FibonacciSeries/FibonacciSeries.vm > /dev/null
...
./translator ProgramFlow/BasicLoop/BasicLoop.vm > /dev/null
...
./translator FunctionCalls/SimpleFunction/SimpleFunction.vm /dev/null
...
./translator FunctionCalls/NestedCall > /dev/null
...
./translator FunctionCalls/FibonacciElement > /dev/null
...
./translator FunctionCalls/StaticsTest > /dev/null
